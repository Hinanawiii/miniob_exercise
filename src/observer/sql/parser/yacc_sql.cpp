...
static const yytype_int16 yyrline[] =
{
     ...
     405,   420,   432,   447,   469,   479,   484,   495,   498,   501,
     504,   507,   511,   514,   522,   529,   541,   546,   557,   560,
     574,   577,   590,   593,   599,   602,   607,   614,   626,   638,
     650,   665,   666,   667,   668,   669,   670,   674,   687,   695,
     705,   706
};
#endif
...
#line 405 "yacc_sql.y"
        ...
        char *y=common::substr((yyvsp[0].string),1,p1-1);
        char *m=common::substr((yyvsp[0].string),p1+1,p2-1);
        char *d=common::substr((yyvsp[0].string),p2+1,strlen((yyvsp[0].string))-2);
